...
"""
Time Warp II Utilities Module
==========================

Utility functions and helper classes for Time Warp II.

This module provides shared functionality used across different parts of the
Time Warp II system, including helper functions for string processing, math
