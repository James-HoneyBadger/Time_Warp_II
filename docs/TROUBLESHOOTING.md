...
### PILOT-Style Commands

**Problem:** No output from T: command
- Solution: Ensure text follows `T:` with no extra spaces
...
- Solution: Ensure PENDOWN is active (it is by default)

**Problem:** Unexpected turtle position
- Solution: Use HOME to reset turtle to center
