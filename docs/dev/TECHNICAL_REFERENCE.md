...
Complete technical documentation for developers extending Time Warp II.
...
Time Warp II uses a **single-language interpreter architecture** where:
...
```
Time_Warp_II/
├── TimeWarpII.py              # Main entry point (GUI)
...
2. Integrate in GUI (`TimeWarpII.py`)
